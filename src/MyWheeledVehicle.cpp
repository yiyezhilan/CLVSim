...
MyWheeledVehicle::MyWheeledVehicle(const std::string& filename,
                                   std::shared_ptr<ChDrivelineWV> driveline,
                               ChContactMethod contact_method,
                               bool create_powertrain,
                               bool create_tires)
    : ChWheeledVehicle("", contact_method) {
    Create(filename, driveline, create_powertrain, create_tires);
}

MyWheeledVehicle::MyWheeledVehicle(ChSystem* system,
...
void MyWheeledVehicle::Create(const std::string& filename,
                              std::shared_ptr<ChDrivelineWV> driveline,
                              bool create_powertrain,
                              bool create_tires) {
    ...
    assert(subtype.compare("MyWheeledVehicle") == 0);
...
void MyWheeledVehicle::Initialize(const ChCoordsys<>& chassisPos, double chassisFwdVel) {
